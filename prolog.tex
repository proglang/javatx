...
\newcommand{\constraint}{\ensuremath{c}}%{\ensuremath{\mathtt{C}}}
\newcommand{\consSet}{\ensuremath{\overline{\constraint}}}%{\ensuremath{\overline{\mathtt{C}}}}
...
\newcommand{\typeAssumptionsSymbol}{\ensuremath{\Pi}}
\newcommand{\typeAssumptions}{\ensuremath{(\overline{\methodAssumption} ; \overline{\fieldAssumption}; \overline{\localVarAssumption})}}
\newcommand{\constraints}{\ensuremath{\mathtt{\overline{C}}}}
\newcommand{\itype}[1]{\ensuremath{#1}}
\newcommand{\type}[1]{\texttt{#1}}
\newcommand{\gType}[1]{\texttt{#1}}
\newcommand{\methodAssumption}{\ensuremath{\mathtt{\pi}}}
\newcommand{\fieldAssumption}{\ensuremath{\mathtt{\tau}}}
\newcommand{\localVarAssumption}{\ensuremath{\mathtt{\Gamma}}}
