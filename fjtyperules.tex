...
\begin{tabularx}{\textwidth}{X c X r}
  ...
  \mathtt{\Pi(\exptype{C}{\ol{X}}.m) =  \ol{T} \to T }\\
...
\textbf{Class Typing:}\\[1em]
  ...
  & $\ddfrac{
    \begin{array}{c}
      \mathtt{\Pi' = \Pi + \set{\exptype{C}{\ol{X}}.m : \ol{T_m} \to T_m \,
      |\, m \in \ol{M}} } \\
      \mathtt{\Pi'' = \Pi + \set{\exptype{C}{\ol{X}}.m :
      \exptype{}{\ol{Y} \subeq  \ol{P}} \ol{T_m} \to T_m \,
      |\, m \in \ol{M}} } \\
