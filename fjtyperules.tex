...
$\mathtt{\ddfrac{\begin{array}{c}
  \mathtt{\Pi(m) = \ol{U} \to U } \quad \quad 
  \mathtt{\triangle; \Gamma \vdash e_0 : T_0 } \quad \quad  %\quad \quad
  \mathtt{\triangle; \Gamma \vdash \ol{e} : \ol{S} } \quad \quad
  \mathtt{\triangle \vdash \ol{S} <: \ol{U}}
\end{array}}
{\triangle; \Gamma \vdash \mathtt{e_0.\mv{m}(\overline{e}) : U }}
}$ & & GT-L-INVK\\
