...
\textbf{match-rule:} A solution which solves both constraints $a \lessdot \exptype{C}{\ol{X}}, a \lessdot \exptype{D}{\ol{Y}}$
also solves $a \lessdot \exptype{C}{\ol{X}}, \exptype{C}{\ol{X}} \lessdot \exptype{C}{\ol{Y}}$.
When we delete the $a \lessdot \exptype{D}{\ol{Y}}$ constraint
we have to make sure that $\ol{Y}$ gets also assigned the right types.
We do this by adding the $\exptype{C}{\ol{X}} \lessdot \exptype{C}{\ol{Y}}$ constraint.
When $\exptype{C}{\ol{X}}$ is a subtype of $\exptype{D}{\ol{Y}}$ and $a$ is a subtype of $\exptype{C}{\ol{X}}$
then $a$ must also be a subtype of $\exptype{D}{\ol{Y}}$.
