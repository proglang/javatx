...
\begin{lstlisting}
class UsePair2 {
  <X,Y> Object prc((*@\erased{Pair<X,Y>}@*)p) {
...
\begin{gather*}
  ...
  \qquad
  \mv{prc} \stackrel{\mv{X,Y}/\mv{X,Y}}{\longrightarrow} \mv{\red{swap}}
\end{gather*}
...
\begin{proposition}\label{prop:polymorphi-recursion}
  If a class \mv{C} with $n$ mutually recursive methods does not exhibit
