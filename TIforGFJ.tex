              ...
              & \begin{array}{ll@{}l}
                  ...
                  \textbf{in} 
                               & { ( \Pi, 
                                 ...
                                 \typeMethod( (\Pi;
                                 \ol{\fieldAssumption}), \exptype{C}{\ol{X}},  \mathtt{m}))
                                 } 
                \end{array}
    \end{array}
  \end{gather*}
...
& \begin{array}{ll}
\textbf{let}& ({R}, \consSet_R) = \typeExpr(({\mtypeEnvironment} ; \overline{\fieldAssumption};
  \overline{\localVarAssumption}), \texttt{e})\\
...
\begin{theorem}\textbf{Soundness:}
  If $\fjtype{}(\mv{\Pi},\texttt{L}) = \mv{\Pi}'$, then there exists a $\mv{\Pi}''$ with $\mv{\Pi} \vdash \texttt{L} : \mv{\Pi}''$
\end{theorem}
\textbf{Proof:}
...
The \unify{} algorithm can return multiple solutions.
...
$\begin{array}{c}
\mv{\Pi}' = \mv{\Pi} \cup \set{ \exptype{C}{\ol{X}}.\texttt{m} \mapsto \exptype{}{\ol{Y} \triangleleft \ol{P}}\ \ol{T} \to \type{T}
 \ |\ \exptype{C}{\ol{X}}.\texttt{m} \mapsto \overline{\itype{T}} \to \itype{T} \in \overline{\methodAssumption} } \\
\text{with}\ \ol{Y} = \textbf{TODO}%TODO: What is needed here? Maybe start with the proof first
\end{array}$

\textbf{Proof:}
Theorem: Every solution of the \unify{} algorithm is correct (Soundness)
% A solution of a constraint is in solved form. Does not contradict any of the constraints generated by \fjtype{}
