...
$\fjtype : \typeAssumptions \times \texttt{L} \rightarrow \ol{C}\\
 \begin{array}{@{}l@{}l}
  ...
  & \begin{array}{l@{}l@{}l}
    ...
    \end{array}\\
  \textbf{in} & \{ \ \typeMethod( (\ol{\methodAssumption} \cup \ol{\methodAssumption}' \cup \ol{\methodAssumption}_o , \ol{\fieldAssumption}, \{ \mathtt{this} : \exptype{C}{\ol{X}} \}, \mathtt{m}) \ |\ \mathtt{m} \in \overline{M} \ \}
   \cup \constraints_o \\ 
  \end{array}
\end{array}$
...
& \textbf{let}
& \underline{(e:rty, \constraints)} = \typeExpr((\overline{\methodAssumption} ; \overline{\fieldAssumption}; \overline{\localVarAssumption} \cup \{ \overline{T} : \overline{x} \}), e)\\
& \mathbf{in}
& (\constraints \cup (rty \lessdot T_r))\\
\end{array}
$
...
\begin{array}{@{}l@{}l}
\typeExpr & (\typeAssumptions, \mathtt{this}) = (t , \{\})\\
& \textbf{with } (\mathtt{this} : t) \in \typeAssumptions 
\end{array}
$
\smallskip
$\begin{array}{@{}l@{}l}
  \typeExpr &(\typeAssumptions,x) = (t , \{\})\\
& \textbf{with } (x : t) \in \typeAssumptions 
\end{array}
$
