...
%TODO: What is with type variables used in two methods at the same time?


The following constraints belong to a method:
\begin{align*}
\ddfrac{T\ m(\ol{T})}{
  \set{a \triangleleft N \ |\ (a \lessdot N) \in Uni',\ a \in T \cup \ol{T}} \cup
...
\begin{align*}
  \ddfrac{
    \exptype{}{A \triangleleft \exptype{C}{\ol{X}}, \ol{A} \triangleleft \ol{N} }\ T\ m(\ol{T}\ \ol{p}) \{ \ldots \}
  }{
    \begin{array}{c}
    \exptype{}{A \triangleleft \exptype{C}{\ol{X}}, \ol{A} \triangleleft \ol{N}, \set{a \triangleleft \texttt{Object} \ |\ a \in \ol{X},\ (a \lessdot N) \notin Uni'} }\ T\ m(\ol{T}\ \ol{p}) \{ \ldots \}
    \end{array}
  }
\end{align*}
...
\begin{align*}
  \ddfrac{
    ...
    \begin{array}{c}
    \exptype{}{A \triangleleft \exptype{C}{\ol{X}}, \ol{A} \triangleleft \ol{N}, \set{a \triangleleft N \ |\ a \in \ol{X},\ (a \lessdot N) \in Uni'}  }\ T\ m(\ol{T}\ \ol{p}) \{ \ldots \}
    \end{array}
  }
\end{align*}
