...
\relatedversiondetails[cite=ARXIV]{Full Version}{URL to related version} %linktext and cite are optional

\supplement{Source code for the accompaning prototype implementation and ECOOP 2022 approved artifact can be found as follows:}%optional, e.g. related research data, source code, ... hosted on a repository like zenodo, figshare, GitHub, ...
