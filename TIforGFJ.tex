...
\textit{Example:} To illustrate the constraint generation step we will apply it to the program depicted in
...
\noindent
$\typeExpr(({\mtypeEnvironment} ;
\overline{\localVarAssumption}), \texttt{this.snd}) = \left(\tv{b}, \orCons \left\set{
\begin{array}{l}
...
\noindent
$\typeExpr(({\mtypeEnvironment} ;
  \overline{\localVarAssumption}), \texttt{new Pair(...)}) = (\exptype{Pair}{\tv{d},\tv{e}}, \set{\begin{array}[t]{l}
  (\tv{f} \lessdot \tv{d}), (\tv{b} \lessdot \tv{e}),
  (\tv{d} \lessdot \texttt{Object}),\\ (\tv{e} \lessdot \texttt{Object}), \orCons(\ldots)} )
  \end{array}$
