...
$\fjtype : \typeAssumptionsSymbol \times \texttt{L} \rightarrow \ol{\constraint}\\
 \begin{array}{@{}l@{}l}
  ...
  & \begin{array}{l@{}l@{}l}
    ...
    \texttt{m}\ \text{overrides}\ \type{N}.\texttt{m} : \exptype{}{\ol{Y} \triangleleft \ol{P}} \ol{\type{T}} \to \type{T}}\\
    &\ \constraints_o = \set{\tv{a} \lessdot \type{T} \ |\ \texttt{m} \in \ol{M}, 
    \texttt{m}\ \text{overrides}\ \type{N}.\texttt{m} : \exptype{}{\ol{Y} \triangleleft \ol{P}} \ol{\type{T}} \to \type{T}}\\
    ...
    &\ \methodAssumption' = \begin{array}[t]{l}
     \set{ (\exptype{C}{\ol{X}}.\mathtt{m} : \ol{\tv{a}} \to \tv{a}) \ |\ \mathtt{m} \in \ol{M},\\
...
\texttt{M} \rightarrow \ol{\constraint}\\
\begin{array}{@{}l@{}l@{}l}
...
& \consSet_f = \set{\set{\type{R} \lessdot \exptype{C}{\ol{X}},\ \tv{a} \doteq \type{T}} \ |\ \exptype{C}{\ol{X}}.\texttt{f} : \type{T} \in \ol{\fieldAssumption}}\\
