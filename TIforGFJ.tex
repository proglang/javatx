...
$\fjtype : \mathtt{L_{m-ass} \rightarrow L \rightarrow L \times \ol{C}}\\
 \begin{array}{@{}l@{}l}
  \fjtype & (\methodAssumptions, \mathtt{class } \ \exptype{C}{\ol{X} \triangleleft \ol{N}} \ \mathtt{ extends } \ \mathtt{N \{ \overline{T} \ \overline{f}; \, K \, \overline{M} \}}) =\\
  & \begin{array}{l@{}l@{}l}
    \textbf{let} &\ \tv{a}_i, \ol{\tv{a}}, \tv{a} = \textit{fresh type variables} \\ % TODO: Rephrase this
    &\ m_{cons}, m_{override} = \set{\overridesFunc(\methodAssumptions, \exptype{C}{\ol{X}}.\mathtt{m}) \ |\ m \in \ol{M}} \\
    &\ \methodAssumptions' = \begin{array}[t]{l}
     \set{ (\exptype{C}{\ol{X}}.\mathtt{m} : \ol{\tv{a}} \to \tv{a}) \ |\ m \in \ol{M},\ \texttt{m}\ \text{does not override another method}} \\
     \cup \ \methodAssumptions \cup m_{override}\\
    \end{array}\\
  \textbf{in} & \{ \ \typeMethod( \methodAssumptions' \cup \{ \mathtt{this} : \exptype{C}{\ol{X}} \}, \mathtt{m}) \ |\ \mathtt{m} \in \overline{M} \ \} \cup m_{cons} \\ 
  \end{array}
\end{array}$
...
\noindent
$\begin{array}{l}
%\overridesFunc : \methodAssumptions \to m_ass \to \consSet \times \ol{m_ass} \\
\overridesFunc(\methodAssumptions, \exptype{C}{\ol{X}}.m) = \\
...
\ |\ \mathtt{\texttt{N.m} : \exptype{}{\ol{Y}_i \triangleleft \ol{P}_i}\ \ol{T}_i \to T_i} \in \methodAssumptions, \exptype{C}{\ol{X}} <: \texttt{N}} \\
& cons = \set{ \tv{a}_i \lessdot \type{T}_i \ |\ \mathtt{\texttt{N.m} : \exptype{}{\ol{Y}_i \triangleleft \ol{P}_i}\ \ol{T}_i \to T_i} \in \methodAssumptions, \exptype{C}{\ol{X}} <: \texttt{N}} \\
\multicolumn{2}{l}{\textbf{in}\ (ass,\ cons)} \\
\end{array}\\
%\textbf{with}\ \tv{a}_1, \ldots \tv{a}_i, \ldots, \tv{a}_n\ \text{as fresh type variables.}
\end{array}
$
