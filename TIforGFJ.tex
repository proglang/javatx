...
\noindent
$\fjtype : \typeAssumptions \rightarrow \texttt{L} \rightarrow \texttt{L} \times \ol{C}\\
 \begin{array}{@{}l@{}l}
  ...
  & \begin{array}{l@{}l@{}l}
    ...
    &\ m_{cons}, m_{override} = \set{\overridesFunc(\typeAssumptions, \exptype{C}{\ol{X}}.\mathtt{m}) \ |\ m \in \ol{M}} \\
    &\ \typeAssumptions' = \begin{array}[t]{l}
     ...
     \cup \ \typeAssumptions \cup m_{override}\\
    \end{array}\\
...
\noindent
$\begin{array}{l}
%\overridesFunc : \typeAssumptions \to m_ass \to \consSet \times \ol{m_ass} \\
...
\noindent
$\textbf{TYPEMethod}: \typeAssumptions \to
