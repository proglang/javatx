  ...
  & \begin{array}{l@{}l@{}l}
    ...
    &\ m_{ass} = \begin{array}[t]{l}
     ...
     \set{ \exptype{C}{\ol{X}}.\mathtt{m} : \mathtt{\exptype{}{\ol{Y} \triangleleft \ol{P}}\ \ol{T} \to \tv{a}}
      \ |\ \mathtt{\exptype{}{\ol{Y} \triangleleft \ol{P}}\ T\ m'(\ol{T}\ x)} \in \overridesFunc(\mathtt{m}), \mathtt{m} \in \overline{M}} \\ % TODO: add overriden methods
    \end{array}\\
...
\overridesFunc(ass, \exptype{C}{\ol{X}}.m : \exptype{}{\ol{Y} \triangleleft \ol{P}}\ \ol{T} \to T) = \\
  %\forall (\mathtt{N.\texttt{m} : \exptype{}{\ol{Y} \triangleleft \ol{P}}\ \ol{T} \to T}) \in \overridesFunc(\mathtt{m}): \\
