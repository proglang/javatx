...
Eq_{set}\\ 
   ...
   %     S_\leq})\\
    ...
    & \times\, 
      ...
      \set{a \doteq N ) \ | \ M <: N })\\
      & \times\, \set{[a \doteq \theta \ | \  (a \doteq \theta) \in Eq'_2]} \\
      & \times\, \set{[a \lessdot \theta \ | \  (a \lessdot \theta) \in Eq'_2]} \times Eq_1 \\
\end{align*}
...
\textbf{Solved form:} TODO
- only one a < C constraint
- otherwise only a < b and a = C constraints
