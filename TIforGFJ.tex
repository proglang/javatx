...
\typeAssumptions = \overline{\methodAssumption}; \overline{L} \\
\end{align*}
...
\noindent
$\begin{array}{l}
\overridesFunc{} : \typeAssumptions \to \methodAssumption \to \consSet \times \typeAssumptions \\
...
$\typeExpr:\texttt{TypeAssumptions} \times
