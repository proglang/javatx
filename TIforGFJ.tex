...
\end{align*}
A generic instance of a method type is always a subtype of the generic method.
\emph{A type-scheme for a declaratjavatxion is a \emph{principal type-scheme}, if any
