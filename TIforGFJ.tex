...
Generic Featherweight Java has no unique principal typing.
...
to make the program type correct.
...
Proof: The \textbf{Unify} algorithm is complete, so every correct type is included in the solution set.
