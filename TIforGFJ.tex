...
The following constraints are generated by the \texttt{setfst} method:
%this.snd
$\orCons \set{ (\exptype{Pair}{\type{X}, \type{Y}} \lessdot \exptype{Pair}{\tv{w}, \tv{y}}),
(\tv{b} \doteq \tv{y}), (\tv{w} \lessdot \type{Object}), (\tv{y} \lessdot \type{Object}) }$
%this.fst
$\orCons \set{ (\exptype{Pair}{\type{X}, \type{Y}} \lessdot \exptype{Pair}{\tv{u}, \tv{v}}),
(\tv{a} \doteq \tv{u}), (\tv{u} \lessdot \type{Object}), (\tv{v} \lessdot \type{Object}) }$
%new Pair:
$\set{(\tv{x} \lessdot \type{X}), (\tv{y} \lessdot \type{Y}), (\type{Y} \lessdot \tv{x}), (\type{X} \lessdot \tv{y})}$
