...
\begin{figure}[tp]
  \begin{align*}
    % Type
    \itype{T}, \itype{U} &::= \tv{a} \mid \mv{T} \mid \red{\itype{N}} && \text{type variable \red{or bounded type partameter} or type}\\
    \itype{N} &::= \exptype{C}{\il{T}} && \text{class type with type \red{parameters
                                          \sout{variables}}} \\
    % Constraints
