...
\item[Or-Constraint] An Or-Constraint (\orCons{}) consists out of multiple sets of constraints.
...
\noindent
$\fjtype : \mathtt{L \rightarrow \ol{C}}\\
 \begin{array}{@{}l@{}l@{}l}
  \fjtype & (\mathtt{class } \ \exptype{C}{\ol{X} \triangleleft \ol{N}} \ \mathtt{ extends } \ \mathtt{N \{ \overline{T} \ \overline{f}; \, K \, \overline{M} \}}) =\\
& \multicolumn{2}{@{}l@{}}{ \{ \ \typeMethod(\{ \mathtt{this} : \exptype{C}{\ol{X}} \}, \mathtt{m_i}) \quad | \quad \mathtt{m_i} \in \overline{M} \ \} }\\ 
& \multicolumn{2}{@{}l@{}}{ \set{ \tv{a} \lessdot T \  | \ \mathtt{m_i} \in \overline{M},\ \mathtt{\exptype{}{\ol{Y} \triangleleft \ol{P}}\ \tv{a}\ m_i(\ol{T}\ x)} \ \text{overrides} \ \mathtt{\exptype{}{\ol{Y} \triangleleft \ol{P}}\ T\ m_i'(\ol{T}\ x)}}} \\
\end{array}$
...
& & \consSet_f = \set{rty \lessdot \exptype{C}{\ol{X}}, \overline{X} \lessdot \overline{N}}\\
& \mathbf{in}% \\
% &
