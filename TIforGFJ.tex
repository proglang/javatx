  ...
  & \begin{array}{l@{}l@{}l}
    ...
    &\ m_{ass} = \begin{array}[t]{l}
     ...
     \set{ \exptype{C}{\ol{X}}.\mathtt{m} : \mathtt{\exptype{}{\ol{Y} \triangleleft \ol{P}}\ \ol{T} \to \tv{a}}
      \ |\ \mathtt{\exptype{}{\ol{Y} \triangleleft \ol{P}}\ T\ m'(\ol{T}\ x)} \in \textit{overrides}(\mathtt{m}), \mathtt{m} \in \overline{M}} \\ % TODO: add overriden methods
    \end{array}\\
  \textbf{in} & \{ \ \typeMethod( m_{ass} \cup \{ \mathtt{this} : \exptype{C}{\ol{X}} \}, \mathtt{m}) \ |\ \mathtt{m} \in \overline{M} \ \} \\ 
  & \set{ \tv{a}_i \lessdot T_i
  \ |\ \mathtt{\exptype{}{\ol{Y} \triangleleft \ol{P}}\ T_i\ m'(\ol{T}\ x)} \in \textit{overrides}(\mathtt{m}_i), \mathtt{m}_i \in \overline{M}}
  \end{array}
\end{array}$
