...
\texttt{myLi(a,b)}$. This liberal stance leads to semi-infinite chains in
the type ordering.
...
In contrast to \textsf{TEL}, where semi-infinite chains grow in supertype direction, 
in Java semi-infinite chains grow in subtype direction. E.g. for $\exptypett{myLi}{b,a} \olsub \exptypett{List}{a}$ holds:
